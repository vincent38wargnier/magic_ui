...
from app.agents.ui_generator_agent.conditionnal_edges.react_conditionnal import (
    tools_condition,
)
...
async def create_workflow():
    ...
    workflow.add_conditional_edges(
        ...
        path_map={"continue": "tools", "finish": END, "end": END},
    )
            ...
            for message in reversed(final_messages[-3:]):  # Check last 3 messages
                if hasattr(message, "content"):
                    ...
                    if (
                        ...
                        and "View your component here" in message.content
                    ):
